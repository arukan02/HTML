...
<SELECT NAME="satu">
<OPTION VALUE="1">Maaf</OPTION>
<OPTION VALUE="2">Terima Kasih</OPTION>
<OPTION VALUE="3">Selamat Siang</OPTION>
<OPTION VALUE="4">Thanks</OPTION>
</SELECT>

<h2>「また会いましょう」のインドネシア語はでしょうか<br>What is the "Until we meet again" greetings from Indonesia?<br>Apakah Bahasa Indonesia dari "Mata aimashou/Until we meet again"?</h2>
<FORM ACTION="./BasicServlet" METHOD="POST">
