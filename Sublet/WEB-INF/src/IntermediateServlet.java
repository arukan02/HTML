...
public class IntermediateServlet extends HttpServlet {
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        s= s + "<h2>「また会いましょう」インドネシア語では何でしょうか「全部小文字で答えてください」<br>What is \"Until we meet again\" in Indonesian?(use lowercase)<br>Apakah Bahasa Indonesia dari \"Mata aimashou/Until we meet again\"?(jangan gunakan huruf kapital)</h2>\n";
